...
available_tones = {
    BuzzerType.FINAL_COUNTDOWN: (final_countdown_melody, final_countdown_tempo, 0.30, 1.2000),
    BuzzerType.BONNAGARD: (bonnagard_melody, bonnagard_tempo, 0.30, 0.800),
    BuzzerType.MANADERNA: (manaderna_melody, manaderna_tempo, 0.30, 0.800),
    BuzzerType.DECK_THE_HALLS: (deck_the_halls_melody, deck_the_halls_tempo, 0.30, 0.800),
    BuzzerType.CRAZY_FROG: (crazy_frog_melody, crazy_frog_tempo, 0.30, 0.900),
    BuzzerType.TWINKLE_TWINKLE: (twinkle_twinkle_melody, twinkle_twinkle_tempo, 0.50, 1.000),
    BuzzerType.POPCORN: (popcorn_melody, popcorn_tempo, 0.50, 1.000),
    BuzzerType.STAR_WARS: (star_wars_melody, star_wars_tempo, 0.50, 1.000),
    BuzzerType.SUPER_MARIO: (melody, tempo, 1.3, 0.800),
    BuzzerType.UNDERWORLD: (underworld_melody, underworld_tempo, 1.3, 0.800),
    BuzzerType.ADVENTURE_TIME: (adventure_time_melody, adventure_time_tempo, 1.3, 1.500)
}